...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------ZahirGanteng'+'wanz--GANS';
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'Wanzbot') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Wanzbot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Wanzofc/Asupan/main/cecan/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/randomquotes`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hadits', async (req, res, next) => {
    ...
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       ...
       fetch(encodeURI(`https://hadits-api-wanz.vercel.app/books/${kitab}/${nomor}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fbdown', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://fb-api-wanz.vercel.app/?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/kisahnabi', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatashar', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/Islamic.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/pegunungan', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/My-SQL-Results/main/Mountain.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/wanz/wanz-Database/main/adzan/${kota}/2021/03.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://fakename-api-wanz.vercel.app/api/fakename?country=${country}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://hilih-api-wanz.vercel.app/api/hilih?kata=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/liriklagu', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/lirik?search=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/chordlagu', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kbbi', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://kbbi-api-wanz.vercel.app/api/kbbi?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidindo', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-wanz.vercel.app/api/covid-indonesia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidworld', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-wanz.vercel.app/api/world`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kodepos', async (req, res, next) => {
	...
	if(!kota) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kota"})
       ...
       fetch(encodeURI(`https://kodepos-api-wanz.vercel.app/?q=${kota}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnn', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/cnn-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnbc', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/cnbc-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/republika', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/republika-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/tempo', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/tempo-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/antara', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/antara-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/kumparan', async (req, res, next) => {
	...
	if(apikeyInput != 'Wanzbot') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://news-api-wanz.vercel.app/v1/kumparan-news`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/video', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/ytv?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/audio', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/yta?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ig/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://python-api-wanz.herokuapp.com/api/stalk?username=${username}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/github/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://github-api-wanz.vercel.app/api/detailuser?q=${username}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/repository/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan nama repository yang ingin kamu cari"})
       ...
       fetch(encodeURI(`https://github-api-wanz.vercel.app/api/searchrepo?q=${username}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
